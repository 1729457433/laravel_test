...
define(['jquery', 'admin.plugs'], function () {
    ...
    this.$body.on('click', '[data-update]', function () {
        ...
        var msg = $(this).attr('data-msg') || '确定要操作这些数据吗？';
    ...
    this.$body.on('click', '[data-file]', function () {
        ...
        var url = '/index.php/admin/plugs/upfile.html?mode=' + method + '&uptype=' + uptype + '&type=' + type + '&field=' + field;
    ...
    this.$body.on('click', '[data-icon]', function () {
        ...
        var url = '/index.php/admin/plugs/icon.html?field=' + field;
