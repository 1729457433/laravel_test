...
(function ($, undefined) {
    ...
    $.mobiscroll.presets.scroller.select = function (inst) {
        ...
        $('#' + id).remove();
        input = $('<input type="text" id="'+id+'" class="' + s.inputClass + '" placeholder="' + (s.placeholder || '') + '" readonly style="height: 46px;font-weight: normal;position: absolute;top: 0;left: 0;color: #44B0EE;width: 45%;padding: 0 10px; font-size: 14px;"/>');
        // input = $('<input class="pageHeaderLeft">')
        if (s.showInput) {
